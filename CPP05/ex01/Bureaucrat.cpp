...
/*   Updated: 2023/11/13 14:20:26 by tas              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form &f)
{
	try
	{
		...
		std::cout << this->_name << " signed " << f.getNameForm() << std::endl;
		std::cout << "\x1b[0m";
	}
	catch (const std::exception &b)
	{
		std::cout << "\x1b[38;5;173m";
		std::cerr << this->_name << " couldn't sign " << f.getNameForm() << " because " << b.what() << std::endl;
		std::cout << "\x1b[0m";
	}
}
